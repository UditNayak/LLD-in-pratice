public class GumballMachine {
    ...
    final static int NO_QUARTER = 1;        // waiting for a quarter
    final static int HAS_QUARTER = 2;       // has a quarter
    final static int SOLD = 3;              // gumball is being dispensed

    int state = SOLD_OUT;       // current state of gumball machine
